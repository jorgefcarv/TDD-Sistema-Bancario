...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/jorgefcarv/sistema-bancario-java-junit/maven[GitHub Workflow Status]
